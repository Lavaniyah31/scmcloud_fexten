                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-1 px-2">
                            <a href="<?php echo base_url('category/p/' . remove_space($cat['category_name']) . '/' . $cat['category_id']) ?>"
                                class="d-flex align-items-center text-black" style="font-size: 12px; line-height: 1.3;">
                                <i data-feather="chevron-right" class="mr-1" style="width: 12px; height: 12px; flex-shrink: 0;"></i>
                                <span class="name text-truncate"><?php echo html_escape($cat['category_name']) ?></span>
                                <span class="total text-black-50 ml-1" style="white-space: nowrap;">(<?php echo html_escape($no_of_pro); ?>)</span>
                            </a>
                        </div>
                        <?php
                                }
        ...
        <div class="<?php echo (!empty($after_search) ? 'col-md-9' : 'col-md-9') ?> mainContent category-content">
            ...
            <div class="row">
                ...
                <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-2">
                    <div class="feature-card card mb-2">
                        <div class="card-body">
